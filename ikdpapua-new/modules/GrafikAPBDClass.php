<?php
Class GrafikapbdClass extends ModulClass{
	function service(){
		$response = array();
		// Pendapatan Grafik
	...
	function manage(){
		...
		$table->init(THEME.'/grafik/apbd.html');
		$define = array (
					'PAGETITLE'	=> 'Grafik Ringkasan APBD Kabupaten/Kota',
					'OPTTAHUN' => $option,
		);
			...
			getGraf = function(tahun) {
                ...
                $.ajax({
                    ...
                    success: function(response){
                        config.element      = 'graf-ringkasan-apbd';
