<div class="navclue abu-abu">	
	<div class="clue"><a href="#">Form TPB 04 <?php if (@$_POST['bulan']) echo 'Triwulan ke '.$this->util->triwulan(@$_POST['bulan']).' Tahun '.$_POST["tahun"]; ?></a>
		</div>
		</div>
		<script>
			$(document).ready(function() {
					var kodeskpd = '<?php echo $this->data['id'];?>';
					 		...
					 		window.location = '?pg=datatpb&mode=tpb04&kodeskpd='+$(this).val();
					 		});
			...
			function edit(nip) {		
				$("#periode").attr('target','');		
				$("#periode").attr('action','?pg=datatpb&mode=edt_tpb04&kodeskpd=<?php echo $this->data['id'];?>');		
				$("#fbulan").val($("#bulan").val());		
				$("#ftahun").val($("#tahun").val());		
				$("#fnip").val(nip);		
				$("#periode").submit();		
			...
			function cetak(nip) {		
				...
				$("#periode").attr('action','?pg=datatpb&mode=print_tpb04&kodeskpd=<?php echo $this->data['id'];?>');		
				$("#fbulan").val($("#bulan").val());		
				$("#ftahun").val($("#tahun").val());		
				$("#fnip").val(nip);		
				$("#periode").submit();		
			...
			<form id="periode" method="post" target="">
				...
				<div class="ket">    	
					...
					<tr>
						...
						<td>: <?php echo "".$this->optBulan(@$_POST["bulan"]).""; ?> <?php echo "".$this->optTahun(@$_POST["tahun"]).""; ?></td>
						</tr>        
						</table>    
						</div>    
						<div class="nav-table">
							<div class="ll">
								<a href="#" class="aksi" alt="tampilkan" id="tampilkan">
									...
									<table class="tabdata">    	
										...
										<?php if (@$_POST['cetaknip']) {	echo "<script>cetak('".$_POST['cetaknip']."');</script>";	
									}?>