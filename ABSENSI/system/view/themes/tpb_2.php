...
<title>Perhitungan Tambahan Penghasilan Bersyarat (TPB) Pemerintah Provinsi Papua</title>
...
<script type="text/javascript" src="js/ucwords.js"></script>
...
<div id="semesta">
        ...
        <div id="fix_footer">
        	<marquee scrollamount="3" onmouseover="this.setAttribute('scrollamount', 0, 0);" onmouseout="this.setAttribute('scrollamount', 3, 0);">
  				<img src="img/papua-kecil.png"/> <p>Selamat Menggunakan Sistem Aplikasi Perhitungan Tambahan Penghasilan Bersyarat (TPB)</p>
  			</marquee>
        </div>
        <div id="main">
