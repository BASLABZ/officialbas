...
<div class="navclue abu-abu">
	<div class="clue"><a href="#">TAMBAH PRESENSI MANUAL</a></div>
</div>
<div class="canvas-content">
    ...
    <tr><td width="150px">Type Absen</td><td><select name="type"><?php echo $this->optTypeAbsen();?></select></td></tr>
    <tr><td width="150px">Tanggal</td><td><input type="text" name="tanggal" id="tanggal" /></td></tr>
    <tr><td width="150px">Jam</td><td><input type="text" name="jam" id="jam" /></td></tr>
