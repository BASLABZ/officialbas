...
<div class="navclue abu-abu">
	<div class="clue"><a href="#">TAMBAH DATA - <?php echo strtoupper($this->getJenisIjin($_GET['id']));?></a></div>
</div>
<div class="canvas-content">
    ...
    <tr><td width="150px">Pegawai</td><td><select name="nip"><?php echo $this->optPegawai(($this->user['kodeskpd'] <> '')?$this->user['kodeskpd']:$_GET['kodeskpd']);?></select></td></tr>
    <tr><td width="150px">Tanggal Awal</td><td><input type="text" name="date_start" id="date_start"/></td></tr>
    <tr><td width="150px">Jam Awal</td><td><input type="text" name="time_start" id="time_start"/></td></tr>
    <tr><td width="150px">Tanggal Akhir</td><td><input type="text" name="date_end" id="date_end"/></td></tr>
    <tr><td width="150px">Jam Akhir</td><td><input type="text" name="time_end" id="time_end"/></td></tr>
    <tr><td width="150px">Keterangan</td><td><textarea name="keterangan" cols="40"></textarea></td></tr>
    <tr><td colspan="2">&nbsp;</td></tr>
    <tr><td colspan="2">
    					<input type="hidden" value="insert" name="mode"/>
                        <input type="hidden" value="<?php echo $_GET['kodeskpd'];?>" name="kodeskpd"/>
                        <input type="hidden" value="<?php echo $_GET['id'];?>" name="idjenis"/>
