 ...
 * of this value object you may modify the generated sub-class of this class - Admin.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Admin extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _AdminEntityMetadata;
     ...
     * properties
     */
    private var _internal_idadmin : String;
    ...
    public function _Super_Admin()
    {
        _model = new _AdminEntityMetadata(this);
    ...
    public function get idadmin() : String
    {
        return _internal_idadmin;
    }
    ...
    public function set idadmin(value:String) : void
    {
        var oldValue:String = _internal_idadmin;
        if (oldValue !== value)
        {
            _internal_idadmin = value;
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _AdminEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _AdminEntityMetadata) : void
    {
        var oldValue : _AdminEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
